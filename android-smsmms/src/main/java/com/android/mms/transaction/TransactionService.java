...
//                            MessagingNotification.updateDownloadFailedNotification(this);
    ...
    protected int beginMmsConnectivity() throws IOException {
            ...
            for (Network network : networks) {
                ...
                if (capabilities != null && capabilities.hasTransport(NetworkCapabilities.TRANSPORT_WIFI)) {
                    if (capabilities.hasCapability(NetworkCapabilities.NET_CAPABILITY_INTERNET) &&
                        ...
                        Log.v(LogTag.TRANSACTION, "beginMmsConnectivity: Wifi active");
                        return 0;
                    }
                }
            }
        ...
        mConnMgr.requestNetwork(networkRequest, new ConnectivityManager.NetworkCallback() {
            ...
            public void onAvailable(Network network) {
                ...
                Log.v(LogTag.TRANSACTION, "beginMmsConnectivity: Mobile network available for MMS");
            ...
            public void onUnavailable() {
                Log.e(LogTag.TRANSACTION, "beginMmsConnectivity: Unable to establish MMS connectivity");
                // You can handle this by throwing an IOException if necessary
            }

            @Override
            public void onLost(Network network) {
                Log.e(LogTag.TRANSACTION, "beginMmsConnectivity: Mobile network for MMS lost");
    ...
    protected void endMmsConnectivity() {
        try {
            Log.v(LogTag.TRANSACTION, "endMmsConnectivity");
